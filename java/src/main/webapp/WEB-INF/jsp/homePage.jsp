...
<section id="nationalParks" class="parks">
	...
	<section class="parks">
		...
		<img src="${cvnpImgSrc}" alt="Cuyahoga Valley National Park">
		<p>Located in Ohio!</p>
	...
	<section class="parks">
		...
		<img src="${enpImgSrc}" alt="Everglades National Park">
	...
	<section class="parks">
		...
		<img src="${gcnpImgSrc}" alt="Grand Canyon National Park">
	...
	<section class="parks">
		...
		<img src="${gnpImgSrc}" alt="Glacier National Park">
	...
	<section class="parks">
		...
		<img src="${gsmnpImgSrc}" alt="Great Smoky Mountains National Park">
	...
	<section class="parks">
		...
		<img src="${gtnpImgSrc}" alt="Grand Teton National Park">
	...
	<section class="parks">
		...
		<img src="${mrnpImgSrc}" alt="Mount Rainier National Park">
	...
	<section class="parks">
		...
		<img src="${rmnpImgSrc}" alt="Rocky Mountain National Park">
	...
	<section class="parks">
		...
		<img src="${ynpImgSrc}" alt="Yellowstone National Park">
		<p>Located in Wyoming!</p>
	...
	<section class="parks">
		...
		<img src="${ynp2ImgSrc}" alt="Yosemite National Park">
